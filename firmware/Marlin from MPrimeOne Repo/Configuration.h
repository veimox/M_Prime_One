...
#define STRING_CONFIG_H_AUTHOR "veimox" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "M Prime One"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "2613dcd3-8e50-4fa6-a992-bebb2382a95f"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
 ...
 // M Prime One with E3D v6 Lite
  #define  DEFAULT_Kp 32.73
  #define  DEFAULT_Ki 2.45
  #define  DEFAULT_Kd 109.39
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  //    O-- FRONT --+
  //  (0,0)
  #define X_PROBE_OFFSET_FROM_EXTRUDER 24  // X offset: -left  [of the nozzle] +right
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 4  // Y offset: -front [of the nozzle] +behind
  ...
  #define Z_RAISE_BETWEEN_PROBINGS 0  // How much the Z axis will be raised when traveling from between next probing points.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,104}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {200, 200, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {500,500,10,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
